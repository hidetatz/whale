...
class WhaleTest(unittest.TestCase):
    ...
    def test_backprop(self):
        ...
        self.assertEqual(results["whale_grad_t1"].tolist(), results["torch_grad_t1"].tolist())
        self.assertEqual(results["whale_grad_t2"].tolist(), results["torch_grad_t2"].tolist())
        self.assertEqual(results["whale_grad_t3"].tolist(), results["torch_grad_t3"].tolist())
        self.assertEqual(results["whale_grad_t4"].tolist(), results["torch_grad_t4"].tolist())
        self.assertEqual(results["whale_grad_t5"].tolist(), results["torch_grad_t5"].tolist())
