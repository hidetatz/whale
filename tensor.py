...
class Tensor:
    ...
    def str_oneline(self):
        return f"Tensor(code: {self.code} {self.shape}_{self.strides}_{self.offset}_{self.valid_area} cpu_buff:{'o' if self.cpu_buffer else 'x'} dev_buff:{'o' if self.dev_buffer else 'x'})"
